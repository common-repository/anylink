...
Tags: seo, link sanitize, covert external links to internal links, short url
...
= 0.3.0 =
*   增加了白名单设置，所有白名单中的链接都不会自动生成内部链接，如果白名单中的是域名，则含有该域名的所有链接都不转换
*   在发表文章界面增加了一个控制开关，如果该选项被选中，那么该文章中的所有链接都不会进行转换
